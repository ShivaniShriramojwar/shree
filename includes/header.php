...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-eOJMYsd53ii+scO/bJGFsiCZc+5NDVN2yr8+0RDqr0Ql0h+rP48ckxlpbzKgwra6" crossorigin="anonymous">
    ...
    <title>PHP Primer_ <?php echo $title ?></title>
</head>
<body>
     <div class="container">
     <h2>Follow each link </h2>
     <ul class="nav-pills">
     ...
     <li class="nav-item"><a class="nav-link" href="while.php">Simple While and do while</a> </li>
     ...
     <li class="nav-item"><a class="nav-link" href="stringmng.php">Simple String Manipulation</a> </li>
